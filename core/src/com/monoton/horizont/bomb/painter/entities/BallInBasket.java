...
import com.monoton.horizont.bomb.painter.math.*;

public class BallInBasket extends Actor{

    private LogarithmicSpiral polarGraph;
    ...
    public BallInBasket(TextureRegion ballTexture, float pointX, float pointY, float basketCenterX, float basketCenterY, float angle, float screenWidth, float screenHeight, float dimension) {
        ...
        this.polarGraph = new LogarithmicSpiral(pointX,pointY,basketCenterX, basketCenterY,angle);
    ...
    public void draw(Batch batch, float parentAlpha) {
        ...
        if(stateTime<animationTime){
            ...
            Vector2 cartesianPoint = polarGraph.getCartesianPoint(ratio);//ratio*2*MathUtils.PI
